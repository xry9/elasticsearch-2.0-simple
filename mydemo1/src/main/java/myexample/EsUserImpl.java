...
//     * @param id
//     * @return
//     * @see com.qiyongkang.es.service.EsUserService#getEntityById(String,
//     *      String, int)
//     */
...
//     *
//     * @param userList
//     * @see com.qiyongkang.es.service.EsUserService#batchInsert(List)
//     */
//    @Override
...
//     * 单个删除.
//     * @param id
//     * @see com.qiyongkang.es.service.EsUserService#singleDelete(String)
//     */
//    @Override
...
//     * 批量更新.
//     * @param updateList
//     * @see com.qiyongkang.es.service.EsUserService#batchUpdate(List)
//     */
//    @Override
