...
public abstract class Engine implements Closeable {
    ...
    protected Engine(EngineConfig engineConfig) {
        ...
        logger.info("===Engine===95==="+store.directory()+"==="+shardId);
    ...
    final protected GetResult getFromSearcher(Get get) throws EngineException {
        ...
        try {
            //xlogger.info("===getFromSearcher===236==="+get.uid()+"==="+searcher.reader().leaves().get(0).getClass().getName());try { Integer.parseInt("getFromSearcher"); }catch (Exception e){logger.error("===", e);}
       ...
       //xlogger.info("===getFromSearcher===251==="+(docIdAndVersion != null));
        if (docIdAndVersion != null) {
        ...
        try {
            ...
            *  in the catch block and throw the right exception */
            ...
            try {
                ...
                //xlogger.info("===acquireSearcher===287==="+source+"==="+retVal.getClass().getName());
    ...
    public static class Searcher implements Releasable {
        ...
        public Searcher(String source, IndexSearcher searcher) {
            ...
            //xlogger.info("===Searcher===590==="+searcher.getClass().getName()+"==="+source);
        }
        /**
        ...
        public IndexReader reader() {
            //xlogger.info("===reader===600===");//try { Integer.parseInt("reader"); }catch (Exception e){logger.error("===", e);}
    ...
    public static final class Create extends IndexingOperation {
        ...
        public Create(Term uid, ParsedDocument doc, long version, VersionType versionType, Origin origin, long startTime, boolean canHaveDuplicates, boolean autoGeneratedId) {
            ...
            logger.info("===Create===766==="+uid);//try { Integer.parseInt("Create"); }catch (Exception e){logger.error("===", e);}
        }
